...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url()?>style/extra-libs/multicheck/multicheck.css">
    <link href="<?php echo base_url()?>style/libs/datatables.net-bs4/css/dataTables.bootstrap4.css" rel="stylesheet">
    <link href="<?php echo base_url()?>style/libs/flot/css/float-chart.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="<?php echo base_url()?>style/css/style.min.css" rel="stylesheet">
    <link href="<?php echo base_url()?>style/libs/toastr/build/toastr.min.css" rel="stylesheet">
